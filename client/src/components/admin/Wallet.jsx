  ...
  const userInfo = user.userProfile
    ...
    <div className='w-full font-poppins'>
        ...
        <div className='w-full justify-center items-center text-center mt-14'>
            ...
            <h3 className='font-bold text-[32px] my-4'>NGN {user.wallet}.00</h3>
            <p className='text-[12px]'>12.81%</p>
            <div className='flex gap-4 w-full justify-center my-12'>
                <button className='text-white px-8 py-3 bg-btn-purple-gradient whitespace-nowrap' onClick={handleOpenModal}>Add Funds</button>
                {showModal && (
                    <Modal close={handleCloseModal}>
                        <AddFunds/>
                    </Modal>
                )}
                <button className='text- px-8 py-3 whitespace-nowrap' style={{background: "#020d2d"} } onClick={handleWithdrawOpenModal}>Withdraw</button>
                {withdrawShowModal && (
